...
When filing an issue, please check [existing open](https://github.com/aws-samples/sample-malaysia-secure-lz/issues), or [recently closed](https://github.com/aws-samples/sample-malaysia-secure-lz/issues?q=is%3Aissue+is%3Aclosed), issues to make sure somebody else hasn't already
...
See the [LICENSE](https://github.com/aws-samples/sample-malaysia-secure-lz/blob/main/LICENSE) file for our project's licensing. We will ask you to confirm the licensing of your contribution.
